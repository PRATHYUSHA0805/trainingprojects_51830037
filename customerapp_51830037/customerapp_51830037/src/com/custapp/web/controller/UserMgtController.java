...
public class UserMgtController {
	...
	// @PostConstruct
	public void init() {
		userService.addUser(new User("Pandu", "p@gmail.com", "p123", "admin",
				true));
		userService.addUser(new User("Prasanna", "p1@gmail.com", "p1123", "mgr",
				true));
		userService.addUser(new User("Bobby", "pb@gmail.com", "pb123",
				"emp", true));
	}
